...
export const Hero = () => {
  return (
    <div className="bg-stone-950 py-24 text-center px-4">
       ...
       <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
         ...
         <div className="flex flex-col items-center space-y-4">
            <div className="w-12 h-12 bg-stone-900 rounded-full flex items-center justify-center text-cyan-400 border border-white/10">
