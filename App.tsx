    ...
    <div className="min-h-screen bg-[#0f172a] overflow-x-hidden selection:bg-cyan-500/30">
      ...
      <nav className="w-full py-6 px-4 md:px-8 flex justify-between items-center max-w-7xl mx-auto z-50 relative">
        ...
        <div className="flex gap-6">
            <button className="text-slate-400 hover:text-white transition-colors text-sm font-medium hidden sm:block">Products</button>
            <button className="text-slate-400 hover:text-white transition-colors text-sm font-medium hidden sm:block">Enterprise</button>
            <button className="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors backdrop-blur-md border border-white/10">
                Login
            </button>
        </div>
      </nav>
